...
count(distinct case when b.Line_of_business='Flight' and  b.booking_date between '2022-04-01' and '2022-04-30' then b.user_id end) as user_who_brought_ticket_2022
